...
public class FragmentDetailBindingImpl extends FragmentDetailBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.asteroid == variableId) {
            ...
            setViewModel((com.udacity.asteroidradar.detail.DetailViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.udacity.asteroidradar.detail.DetailViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        com.udacity.asteroidradar.detail.DetailViewModel viewModel = mViewModel;
        double asteroidRelativeVelocity = 0.0;
        double asteroidDistanceFromEarth = 0.0;
        java.lang.String viewModelContentDescription = null;
        ...
        if ((dirtyFlags & 0x6L) != 0) {
                ...
                if (viewModel != null) {
                    // read viewModel.contentDescription
                    viewModelContentDescription = viewModel.getContentDescription();
                }
        }
        // batch finished
        if ((dirtyFlags & 0x5L) != 0) {
        ...
        if ((dirtyFlags & 0x6L) != 0) {
            ...
            if(getBuildSdkInt() >= 4) {
                ...
                this.activityMainImageOfTheDay.setContentDescription(viewModelContentDescription);
            }
        }
    }
